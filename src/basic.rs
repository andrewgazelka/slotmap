...
impl<K: Key, V> SlotMap<K, V> {
        ...
        V: Sync,
    {
        ...
        self.slots[1..].par_iter().filter_map(|slot| {
    ...
    /// A parallel iterator visiting all key-value pairs in arbitrary order
    #[cfg(feature = "rayon")]
    pub fn par_iter_mut(&mut self) -> impl rayon::iter::ParallelIterator<Item = &mut V>
    where
        V: Send,
    {
        use rayon::prelude::*;

        self.slots[1..].par_iter_mut().filter_map(|slot| {
